-- CreateEnum
CREATE TYPE "AppointmentStatus" AS ENUM ('SCHEDULE', 'PENDING', 'CONFIRMED', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PAID', 'UNPAID');

-- AlterTable
ALTER TABLE "doctor_schedules" ADD COLUMN     "videoCallLink" TEXT;
